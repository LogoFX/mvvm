...
mkdir net6.0
robocopy ../../../../../src/Bin/net/Release net6.0 LogoFX.Client.Mvvm.ViewModel.Extensions.Platform.* /E
robocopy ../../../../../src/lib/Caliburn.Micro/net45 net6.0 Caliburn.Micro.Platform.* /E
robocopy ../../../../../src/lib/Caliburn.Micro/net45 net6.0 System.Windows.Interactivity.* /E
cd net6.0
rmdir /Q /S ref
cd ..
mkdir netcoreapp3.1
